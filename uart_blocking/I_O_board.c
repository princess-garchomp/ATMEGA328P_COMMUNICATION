...
#define FIRST_RGB_LED_RED_SHIFT (PB5)
#define FIRST_RGB_LED_GREEN_SHIFT (PB4)
#define FIRST_RGB_LED_BLUE_SHIFT (PB3)
...
void first_rgb_led_config(){
	DDRB |= MASK(FIRST_RGB_LED_RED_SHIFT)|MASK(FIRST_RGB_LED_GREEN_SHIFT)|MASK(FIRST_RGB_LED_BLUE_SHIFT);
...
static void first_rgb_led_red_on(){
	PORTB|= MASK(FIRST_RGB_LED_RED_SHIFT);
}
static void first_rgb_led_red_off(){
	PORTB &= ~MASK(FIRST_RGB_LED_RED_SHIFT);
}
static void first_rgb_led_green_on(){
	PORTB |= MASK(FIRST_RGB_LED_GREEN_SHIFT);
}
static void first_rgb_led_green_off(){
	PORTB &= ~MASK(FIRST_RGB_LED_GREEN_SHIFT);
}
static void first_rgb_led_blue_on(){
	PORTB |= MASK(FIRST_RGB_LED_BLUE_SHIFT);
}
static void first_rgb_led_blue_off(){
	PORTB &= ~MASK(FIRST_RGB_LED_BLUE_SHIFT);
}
